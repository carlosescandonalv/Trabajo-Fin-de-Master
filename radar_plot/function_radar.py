...
class Radar:
    ...
    def __init__(
        self, background_color="#FFFFFF", patch_color="#D6D6D6", fontfamily="sans serif", 
    ...
    def plot_radar(self, ranges, params, values, radar_color, filename=None, dpi=300,
        ...
        ## add credits 
        ax.text(7.7, -21.5,"@xLaFrontal Football Analytics" , fontfamily=self.fontfamily, ha='right',
    ...
    def __plot_circles(self, ax, radar_color, vertices, alpha=None, compare=False):
        ...
        if compare:    ## for making comparison radar charts
            ## plot a polygon
            radar_1 = Polygon(vertices, fc=radar_color, edgecolor=radar_color,lw=4,zorder=zorder_circle+1, alpha=alpha)
